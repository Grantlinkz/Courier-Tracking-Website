...
<head>
    ...
    <!-- ======== Page title ============ -->
    <title>Expressline - Transport & Logistics </title>
    <!-- ========== Favicon Icon ========== -->
    ...
    <div class="top-bar-wrapper d-none d-sm-block">
        <div class="container d-flex justify-content-between align-items-center">
            <div class="top-left">
                ...
                <a href="mailto:info@example.com"><i class="fal fa-envelope"></i>support@ascendcourie.online</a>
...
NY 10160, USA</a>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-3 col-sm-5 col-md-4 col-6 pr-lg-5">
                    <div class="logo">
                        <a href="index-2.php">
                        <img src="assets/img/logo.png" height="60px" width="150px" alt="Expressline">       
                        </a>
                    </div>
                </div>
                <div class="col-lg-9 text-end p-lg-0 d-none d-lg-flex justify-content-between align-items-center">
                    <div class="menu-wrap">
                        <div class="main-menu">
                            <ul>
                                ...
                                <li><a href="index-2.php#services">Services</a></li>
                    ...
                    <div class="header-right-element">
                        <a href="index-2.php#track" class="theme-btn">Track <i class="fal fa-long-arrow-right"></i></a>
        ...
        <div class="container">
            <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="index-2.php">About Us</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <?php  
    include 'dbh.inc.php';
        $id=$_SESSION['track_no'];
        $userquery = $conn->query("SELECT * FROM client_details where track_no='$id'");
        while($userdetails = mysqli_fetch_array($userquery)){
        $trackno = $userdetails['track_no']; 
        $sendername = $userdetails['sender_name']; 
        $senderphone = $userdetails['sender_phone'];
        $senderemail = $userdetails['sender_email'];
        $senderlocation = $userdetails['sender_location'];
        $receivername = $userdetails['receiver_name']; 
        $receiverphone = $userdetails['receiver_phone'];
        $receiveremail = $userdetails['receiver_email'];
        $receiverlocation = $userdetails['receiver_location']; }
    ...
    <section class="about-us-wrapper section-padding">
        <div class="container">
                ...
                <div class="col-md-6">
                    <b>Welcome,</b>   | <a href="index-2.php"> Back to Homepage </a>
                </div>
                <div class="col-md-6 text-right">
                    <h4><b>Tracking No : <?php echo $trackno; ?></b>  </h4>
                </div>
                <hr>
                <br>
                <br>
                ...
                <div class="col-md-12 col-md-offset-0">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <table class="table table-hover" id="dev-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Address:</b></td>
                                            <td><?php echo $receiverlocation; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <?php  
                        ...
                        $id=$_SESSION['track_no'];
                        $id2=$_SESSION['id'];
                        $userquery2 = $conn->query("SELECT * FROM location_details where customer_id='$id2'");
                        while($userdetails2 = mysqli_fetch_array($userquery2)){
                        // $trackno = $userdetails2['track_no']; 
                        $pickup = $userdetails2['pickup']; 
                    ...
                    <table class="table table-striped table-bordered table-condensed">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $presentloc; ?></td>
                                <td class="col-xs-6"><marquee> Package out for delivery destination <?php echo $pickup?> &nbsp; </marquee></td>
                            </tr>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xl-3">
                        <div class="about-Expressline pe-md-5 pe-xl-0">
                            <a href="index.html">
                                <img src="assets/img/footer-logo.png" height="80px" width="150px" alt="Expressline">
                            </a>
                            <p style="color:white">Expressline Logistics Services is a global supplier of transport and logistics solutions. We have offices in more than 20 countries and agents.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="copy-rights">
                                <p>&copy;2022 <strong>Expressline</strong>, All Rights Reserved</p>
                            </div>
                        </div>
